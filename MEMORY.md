...
### 2026-05-26 (D6.1) — Bug修复与精准优化
- 地图散点尺寸上限26px + 涟漪缩放降至2.4 (修复大数据溢出)
- 35城市→省份映射 (兼容数据工厂生成的城市名)
- 数据工厂结论引擎: 地区关键词解析 (江浙沪/珠三角/京津冀等9组)
- 年龄正则修复: 匹配"年龄在25-30岁"格式
- 价格分布sigma修复: 对数正态计算公式
- created_at字段 same_as 引用支持
- PyInstaller重新打包 + 老旧文件清理 (build/__pycache__/chrome .old)
- GitHub同步推送 (e9e4939)
